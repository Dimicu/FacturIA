...
def edit_factura(factura_data, factura_img, venta_compra):
    ...
    with col2_form:
        ...
        with datosfactura_container:
            ...
            emisor_nif = st.text_input("NIF/CIF*", factura["emisor"]["NIF_CIF"],max_chars=8)
            ...
            receptor_nif = st.text_input("NIF/CIF Cliente", factura["receptor"]["NIF_CIF"],max_chars=8)
...
edit_factura(st.session_state.get("anadir_factura", {}), st.session_state.get("imagen_factura", ""), st.session_state["venta_compra"])
